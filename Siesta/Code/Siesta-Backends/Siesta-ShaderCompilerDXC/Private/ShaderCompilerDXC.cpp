...
DCompiledData SDXCShaderCompiler::CompileShader(const SShaderCompilerEnvironmentConfiguration& Env, const TString& Path, const TString& EntryPoint, EShaderStage::Type Stage)
{
	// Read file from path
	if (Path.empty())
	{
