...
class SIESTA_RENDERCORE_API SCPUBlob : public SIntrusiveRefCounted
{
public:
	SCPUBlob() = default;
	~SCPUBlob();
...
private:
	...
	friend SIESTA_RENDERCORE_API SCPUBlob CreateCPUBlob(uint64 Size, const void* Data);
	friend SIESTA_RENDERCORE_API SCPUBlob* AllocateCPUBlob(uint64 Size, const void* Data);
};


SIESTA_RENDERCORE_API SCPUBlob CreateCPUBlob(uint64 Size, const void* Data = nullptr);
SIESTA_RENDERCORE_API SCPUBlob* AllocateCPUBlob(uint64 Size, const void* Data = nullptr);